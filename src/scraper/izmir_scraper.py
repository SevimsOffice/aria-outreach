"""
Izmir OSB scrapers — covers the four major organized industrial zones:
  - Kemalpaşa OSB  (kmposb.com.tr)
  - Atatürk OSB    (ataturkosb.org.tr)
  - Çiğli OSB      (cigliorganize.org.tr)
  - Torbalı OSB    (torbali.osb.org.tr)
...
_OSB_CONFIGS = [
    (
        "KEMALPASA",
        ["https://www.kmposb.com.tr", "https://kmposb.com.tr"],
        ["/firmalar", "/uyeler", "/uye-firmalar", "/firmalarimiz", "/uyelerimiz", "/katilimci-firmalar"],
    ),
    (
        "ATATURK",
        ["https://www.ataturkosb.org.tr", "https://ataturkosb.org.tr"],
        ["/firmalar", "/uyeler", "/uye-firmalar", "/firmalarimiz", "/uyelerimiz"],
    ),
    (
        "CİĞLİ",
        ["https://www.cigliorganize.org.tr", "https://cigliorganize.org.tr"],
        ["/firmalar", "/uyeler", "/uye-firmalar", "/firmalarimiz", "/uyelerimiz"],
    ),
    (
        "TORBALI",
        ["https://www.torbali.osb.org.tr", "https://torbali.osb.org.tr"],
        ["/firmalar", "/uyeler", "/uye-firmalar", "/firmalarimiz", "/uyelerimiz"],
    ),
]


def scrape_izmir() -> list[dict]:
    """Scrape all Izmir OSBs and return combined list."""
    session = get_session()
    all_companies: list[dict] = []
    for osb_name, bases, paths in _OSB_CONFIGS:
        companies = _scrape_one_osb(session, osb_name, bases, paths)
        all_companies.extend(companies)
    logger.info(f"İzmir toplam: {len(all_companies)} firma")
